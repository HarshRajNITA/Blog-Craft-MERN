                ...
                {props.newComment
                    ...
                    <div className='flex gap-2 mb-3'>
                        ...
                        <div>
                            ...
                            <p className='text-xs'>{moment(props.newComment?.createdAt).format('DD-MM-YYYY')}</p>
                        ...
                        return (
                            <div key={comment._id} className='flex gap-2 mb-3 ml-2'>
                                ...
                                <div>
                                    ...
                                    <p className='text-xs'>Date: {moment(comment?.createdAt).format('DD-MM-YYYY')}</p>
                                    <p className='text-xs'>Time: {moment(comment?.createdAt).format('hh:mm A')}</p>
                                    <div className='pt-2'>
                                        {comment?.comment}
                                    </div>
                                </div>
